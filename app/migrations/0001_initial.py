# Generated by Django 3.2.12 on 2022-02-27 06:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='activity description', max_length=600)),
                ('status', models.CharField(choices=[('backlog', 'backlog'), ('assigned', 'assigned'), ('in_progress', 'in_progress'), ('in_review', 'in_review'), ('completed', 'completed')], default='backlog', max_length=20)),
                ('assigned_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.volunteer')),
            ],
        ),
    ]
